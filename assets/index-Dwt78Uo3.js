 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(L,R){var F=L.length;L.push(R);e:for(;0<F;){var X=F-1>>>1,J=L[X];if(0<i(J,R))L[X]=R,L[F]=J,F=X;else break e}}function n(L){return L.length===0?null:L[0]}function r(L){if(L.length===0)return null;var R=L[0],F=L.pop();if(F!==R){L[0]=F;e:for(var X=0,J=L.length,mn=J>>>1;X<mn;){var ct=2*(X+1)-1,Bt=L[ct],Ue=ct+1,Tt=L[Ue];if(0>i(Bt,F))Ue<J&&0>i(Tt,Bt)?(L[X]=Tt,L[Ue]=F,X=Ue):(L[X]=Bt,L[ct]=F,X=ct);else if(Ue<J&&0>i(Tt,F))L[X]=Tt,L[Ue]=F,X=Ue;else break e}}return R}function i(L,R){var F=L.sortIndex-R.sortIndex;return F!==0?F:L.id-R.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var s=Date,l=s.now();e.unstable_now=function(){return s.now()-l}}var a=[],u=[],d=1,f=null,y=3,v=!1,w=!1,x=!1,N=typeof setTimeout=="function"?setTimeout:null,p=typeof clearTimeout=="function"?clearTimeout:null,h=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function g(L){for(var R=n(u);R!==null;){if(R.callback===null)r(u);else if(R.startTime<=L)r(u),R.sortIndex=R.expirationTime,t(a,R);else break;R=n(u)}}function S(L){if(x=!1,g(L),!w)if(n(a)!==null)w=!0,ze(j);else{var R=n(u);R!==null&&Be(S,R.startTime-L)}}function j(L,R){w=!1,x&&(x=!1,p(T),T=-1),v=!0;var F=y;try{for(g(R),f=n(a);f!==null&&(!(f.expirationTime>R)||L&&!O());){var X=f.callback;if(typeof X=="function"){f.callback=null,y=f.priorityLevel;var J=X(f.expirationTime<=R);R=e.unstable_now(),typeof J=="function"?f.callback=J:f===n(a)&&r(a),g(R)}else r(a);f=n(a)}if(f!==null)var mn=!0;else{var ct=n(u);ct!==null&&Be(S,ct.startTime-R),mn=!1}return mn}finally{f=null,y=F,v=!1}}var $=!1,C=null,T=-1,D=5,_=-1;function O(){return!(e.unstable_now()-_<D)}function pe(){if(C!==null){var L=e.unstable_now();_=L;var R=!0;try{R=C(!0,L)}finally{R?je():($=!1,C=null)}}else $=!1}var je;if(typeof h=="function")je=function(){h(pe)};else if(typeof MessageChannel<"u"){var Ve=new MessageChannel,$t=Ve.port2;Ve.port1.onmessage=pe,je=function(){$t.postMessage(null)}}else je=function(){N(pe,0)};function ze(L){C=L,$||($=!0,je())}function Be(L,R){T=N(function(){L(e.unstable_now())},R)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(L){L.callback=null},e.unstable_continueExecution=function(){w||v||(w=!0,ze(j))},e.unstable_forceFrameRate=function(L){0>L||125<L?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):D=0<L?Math.floor(1e3/L):5},e.unstable_getCurrentPriorityLevel=function(){return y},e.unstable_getFirstCallbackNode=function(){return n(a)},e.unstable_next=function(L){switch(y){case 1:case 2:case 3:var R=3;break;default:R=y}var F=y;y=R;try{return L()}finally{y=F}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(L,R){switch(L){case 1:case 2:case 3:case 4:case 5:break;default:L=3}var F=y;y=L;try{return R()}finally{y=F}},e.unstable_scheduleCallback=function(L,R,F){var X=e.unstable_now();switch(typeof F=="object"&&F!==null?(F=F.delay,F=typeof F=="number"&&0<F?X+F:X):F=X,L){case 1:var J=-1;break;case 2:J=250;break;case 5:J=1073741823;break;case 4:J=1e4;break;default:J=5e3}return J=F+J,L={id:d++,callback:R,priorityLevel:L,startTime:F,expirationTime:J,sortIndex:-1},F>X?(L.sortIndex=F,t(u,L),n(a)===null&&L===n(u)&&(x?(p(T),T=-1):x=!0,Be(S,F-X))):(L.sortIndex=J,t(a,L),w||v||(w=!0,ze(j))),L},e.unstable_shouldYield=O,e.unstable_wrapCallback=function(L){var R=y;return function(){var F=y;y=R;try{return L.apply(this,arguments)}finally{y=F}}}})(Cu);xu.exports=Cu;var uf=xu.exports;/**
 * @license React
...
`;function ie({children:e,...t}){return c.jsx(l9,{...t,children:e})}ie.propTypes={children:E.any};const a9=V.div`
  position: relative;
  align-items: center;
  display: flex;
  gap: 1.6rem;
...
`;function w1({log:e}){return c.jsxs(a9,{children:[c.jsx("span",{children:B(e.start,"dd.mm.yyyy.")}),c.jsxs("span",{children:["start: ",B(e.start,"hh:mm:ss")]}),c.jsxs("span",{children:["end: ",B(e.end,"hh:mm:ss")]}),c.jsx(Je,{value:e.time})]})}w1.propTypes={log:E.object};const c9=V.div`
  .card-header {
    display: flex;
...
`;function Nn(e){return c.jsx(u9,{...e,$validValue:e.value})}Nn.propTypes={type:E.string,value:E.string};const d9=V.form`
  span {
    font-weight: bold;
    &.red {
      color: ${m.invalid};
...
`;function wi({options:e,initial:t="",className:n="",disabled:r,...i}){const[o,s]=P.useState(""),[l,a]=P.useState(""),[u,d]=P.useState(typeof t=="object"?t.value:t),[f,y]=P.useState(typeof t=="object"?t.text:t),[v,w]=P.useState(""),x=P.useRef(null),N=()=>{o?(a(""),setTimeout(()=>{s(""),w(""),x.current.scrollTo(0,0)},250)):(s("open"),setTimeout(()=>{a("visible")},10))},p=C=>{w(C.target.value)},h=C=>{y(C.target.textContent),d(C.target.dataset.value),N()},g=e.filter(C=>{if(typeof C=="string")return C.toLowerCase().includes(v.toLowerCase());if(typeof C=="object")return C.text.toLowerCase().includes(v.toLowerCase())}),S=g.map(C=>{if(typeof C=="string")return c.jsx("div",{className:f===C?"selected":"",onClick:h,"data-value":C,children:C},Q());if(typeof C=="object")return c.jsx("div",{className:f===C.text?"selected":"",onClick:h,"data-value":C.value,children:C.text},Q())}),j=e.map(C=>{if(typeof C=="string")return c.jsx("option",{value:C,children:C},Q());if(typeof C=="object")return c.jsx("option",{value:C.value,children:C.text},Q())}),$=g.length>5?"scrollable":"";return c.jsxs(p9,{className:`${n} ${o} ${r?"disabled":""}`,children:[c.jsx("div",{className:"head",onClick:N,tabIndex:r?-1:0,children:c.jsx("span",{children:f||"Please select"})}),c.jsxs("div",{className:`body ${l}`,children:[e.length>=10&&c.jsx("input",{type:"text",placeholder:"Search...",spellCheck:"false",value:v,onChange:p}),c.jsx("div",{ref:x,className:`list ${$}`,children:S})]}),c.jsxs("select",{value:u,readOnly:!0,disabled:r,tabIndex:-1,...i,children:[!t&&c.jsx("option",{disabled:!0,hidden:!0,value:"",children:"Please select"}),j]})]})}wi.propTypes={options:E.array.isRequired,initial:E.oneOfType([E.string,E.object]),className:E.string,disabled:E.bool};const h9=V.div`
  display: flex;
  flex-direction: column;
  gap: 0.8rem;
...
`;function y9(e){return c.jsx(g9,{...e})}const su=V.div`
  position: relative;
...
`;function S1({name:e,value:t,label:n,error:r,onChange:i}){const[o,s]=P.useState(!1);P.useEffect(()=>{s(Uh())},[]);const l=u=>{const d=u.target.value;let f;d?f=(t==null?void 0:t.split("T")[1])||new Date().toTimeString().slice(0,5):f="",i(`${d}T${f}`)},a=u=>{const d=u.target.value,f=(t==null?void 0:t.split("T")[0])||new Date().toISOString().split("T")[0];i(`${f}T${d}`)};if(!o){const[u,d]=t?t.split("T"):["",""];return c.jsxs(su,{children:[r&&c.jsx("label",{children:r}),c.jsxs("div",{className:"datetime-wrapper",children:[c.jsx(it,{label:n+"-date",error:r&&" ",children:c.jsx(Nn,{name:e+"Date",type:"date",value:u,onChange:l})}),c.jsx(it,{label:n+"-time",error:r&&" ",children:c.jsx(Nn,{name:e+"Time",type:"time",value:d,onChange:a})})]})]})}return c.jsx(su,{children:c.jsx(it,{label:n,error:r,children:c.jsx(Nn,{name:e,type:"datetime-local",value:t,onChange:i})})})}S1.propTypes={name:E.string,value:E.string,label:E.string,error:E.string,onChange:E.func};function j1({onClose:e}){const t=fe(),n=U(C=>C.ui.formType),r=U(C=>C.data.tempData),i=U(C=>C.projects),[o,s]=P.useState(!1),[l,a]=n.split("-");let u=null;if(a==="task"){let C=i.find(T=>T.id===(l==="new"?r:r.projectId));u=C.deadline?C.deadline:null}else a==="project"&&l==="edit"&&(u=i.find(D=>D.id===r.id).tasks.reduce((D,_)=>_.deadline!==void 0&&_.status==="active"&&_.deadline>D?_.deadline:D,null));const{value:d,handleChange:f,invalid:y}=rl(l==="edit"&&(r!=null&&r.name)?r.name:"",C=>!il(C)),{value:v,handleChange:w,invalid:x}=rl(l==="edit"&&(r!=null&&r.deadline)?B(r.deadline,"yyyy-mm-ddThh:mm:ss"):"",C=>m9(C,a,u)||il(C)),{value:N,handleChange:p,invalid:h}=rl(l==="edit"&&(r!=null&&r.description)?r.description:"",C=>!il(C)),g=C=>{C.target.closest("form").reset(),e()},S=C=>{if(C.preventDefault(),s(!0),y||x||h){setTimeout(()=>{s(!1)},5e3);return}const T=new FormData(C.target),D=Object.fromEntries(T.entries()),_=Pe(r);D.deadlineDate&&D.deadlineTime?(D.deadline=B(D.deadlineDate+"T"+D.deadlineTime,"ms"),delete D.deadlineDate,delete D.deadlineTime):D.deadline?D.deadline=B(D.deadline,"ms"):(_&&delete _.deadline,delete D.deadline),a==="project"?(l==="new"?t(zm(D)):l==="edit"&&t(Om({..._,...D})),t(On())):a==="task"&&(l==="new"?(t(Vm(D)),t(On())):l==="edit"&&(t(Bm({..._,...D})),t(M.setFormType("task-details")))),t(M.setActionOrigin(null)),C.target.reset()};let j,$;return a==="task"&&l==="new"&&(j=i.filter(T=>T.status==="active").map(T=>({text:T.name,value:T.id})),$=j.find(T=>T.value===r)),c.jsxs("form",{className:"form",onSubmit:S,children:[c.jsxs("h2",{children:[l==="new"?"New":"Edit",a==="project"?" project":" task",":"]}),c.jsx("hr",{}),a==="task"&&l==="new"&&c.jsx(it,{label:"Project",children:c.jsx(wi,{name:"projectId",options:j,initial:$})}),c.jsx(it,{label:"Name",error:y&&o?"Please fill this field":"",children:c.jsx(Nn,{name:"name",value:d,onChange:f,autoFocus:!0})}),c.jsx(S1,{name:"deadline",value:v,label:"Deadline",error:x&&o?a==="task"?"The date must not be in the past or later than the project deadline":"The date must not be in the past or earlier than the latest task deadline":"",onChange:w}),c.jsx(it,{label:"Priority",children:c.jsx(wi,{name:"priority",options:["low","medium","high"],initial:r&&typeof r=="object"?r.priority:"low"})}),c.jsx(it,{label:"Description",error:h&&o?"Please fill this field":"",children:c.jsx(y9,{rows:5,name:"description",value:N,onChange:p})}),c.jsx("hr",{}),c.jsxs("div",{className:"button-group",children:[c.jsx(ie,{type:"button",onClick:g,children:"Close"}),c.jsxs(ie,{className:"active",type:"submit",children:[l==="new"?"Create":"Edit",a==="project"?" Project":" Task"]})]})]})}j1.propTypes={onClose:E.func};const v9=V.li`
  position: relative;
  display: flex;
  flex-direction: column;
  align-items: center;
...
`;function b1({state:e,onClick:t}){return c.jsx(D9,{$state:e,children:c.jsx("span",{onClick:t})})}b1.propTypes={state:E.bool,onClick:E.func};const M9=V.header`
...
`;function E1({onClick:e,animated:t}){return c.jsxs(I9,{htmlFor:"checkbox",onClick:e,$animated:t,children:[c.jsx("input",{type:"checkbox",id:"checkbox"}),c.jsx("div",{className:"switch"})]})}E1.propTypes={onClick:E.func,animated:E.bool};const z9="/easytrack/assets/neon-flicker-BegtQltS.wav",O9=V.section`
  display: flex;
  flex-direction: column;
...
`;function j0({item:e,deadline:t=!1,style:n}){const r=fe();let i,o,s,l,a,u,d,f;if(t)e.deadline-G()<2592e5&&(i="yellow"),e.deadline<G()&&(i="red");else if(!t&&e.tasks.length){const w=e.tasks.length;o=e.tasks.filter(x=>x.status==="active").length,s=e.tasks.filter(x=>x.status==="finished").length,l=e.tasks.filter(x=>x.status==="discarded").length,a=o/w*100,u=s/w*100,d=l/w*100,f=s/(o+s)*100,u===0&&(f=0)}let y;e!=null&&e.tasks?y=e.tasks.reduce((w,x)=>w+x.time,0):y=e.time;const v=()=>{Object.hasOwn(e,"projectId")?(r(A.setTempData(e)),r(M.setFormType("task-details")),r(M.changePage("projects"))):e.status==="active"?(r(A.setTempData(e)),r(M.changePage("projects"))):(r(A.setTempData(e)),r(M.changePage("archive")))};return c.jsxs(F9,{$type:e.status,$deadline:t,style:n,onClick:v,children:[c.jsxs("div",{className:"card-header",children:[c.jsx("h2",{children:e.name}),!t&&c.jsx(Je,{value:y,title:"Project track time"})]}),c.jsx("hr",{}),c.jsx("div",{className:"card-body",children:t?c.jsxs("span",{className:i,children:[B(e.deadline,"dd.mm.yyyy.")," (",B(e.deadline,"hh:mm:ss"),")"]}):c.jsxs("div",{className:"info",children:[c.jsxs("div",{className:"tasks",children:[c.jsx("label",{children:"Tasks progress (by category)"}),c.jsxs("div",{children:[c.jsx(Ar,{size:80,percentage:a,number:o,color:m.blue5,title:"Active tasks"}),c.jsx(Ar,{size:80,percentage:u,number:s,color:m.validDark,title:"Finished tasks"}),c.jsx(Ar,{size:80,percentage:d,number:l,color:m.invalidDark,title:"Discarded tasks"})]})]}),c.jsx("span",{className:"vr"}),c.jsxs("div",{className:"progress",children:[c.jsx("label",{children:"Total progress"}),c.jsx("div",{children:c.jsx(Ar,{size:80,percentage:f,color:m.white+k[80],title:"Total progress (discarded excluded)"})})]})]})})]})}j0.propTypes={item:E.object,deadline:E.bool,style:E.object};const A9=V.div`
  display: flex;
  flex-direction: column;
  gap: 1.2rem;
...
`;function P1({data:e,onSelect:t}){const n=e.filter(_=>_.status==="active"),r=e.filter(_=>_.status==="discarded"),i=e.filter(_=>_.status==="finished"),o=e.length,s=n.length/o*100,l=r.length/o*100,a=i.length/o*100,[u,d]=P.useState(0),[f,y]=P.useState(0),[v,w]=P.useState(0),[x,N]=P.useState(!1),[p,h]=P.useState(!1),[g,S]=P.useState(""),j=_=>{_.target.classList.contains("active")?(S("active"),t("active")):_.target.classList.contains("finished")?(S("finished"),t("finished")):_.target.classList.contains("discarded")&&(t("discarded"),S("discarded"))},$=()=>{S(""),t("")};P.useEffect(()=>{let _,O;const pe=s*10,je=Ve=>{_||(_=Ve);const $t=Ve-_,ze=Math.min($t/pe,1),Be=Math.floor(ze*s);d(Be),ze<1?O=requestAnimationFrame(je):(d(s),N(!0))};return O=requestAnimationFrame(je),()=>cancelAnimationFrame(O)},[s]),P.useEffect(()=>{if(!x)return;let _,O;const pe=a*10,je=Ve=>{_||(_=Ve);const $t=Ve-_,ze=Math.min($t/pe,1),Be=Math.floor(ze*a);y(Be),ze<1?O=requestAnimationFrame(je):(y(a),h(!0))};return O=requestAnimationFrame(je),()=>cancelAnimationFrame(O)},[a,x]),P.useEffect(()=>{if(!x||!p)return;let _,O;const pe=l*10,je=Ve=>{_||(_=Ve);const $t=Ve-_,ze=Math.min($t/pe,1),Be=Math.floor(ze*l);w(Be),ze<1?O=requestAnimationFrame(je):w(l)};return O=requestAnimationFrame(je),()=>cancelAnimationFrame(O)},[l,x,p]);const C=3.6*s-360*s/100/2,T=3.6*(s+a)-360*a/100/2,D=3.6*(s+a+l)-360*l/100/2;return c.jsxs(V9,{$active:u,$finished:u+f,$discarded:u+f+v,$category:g,onClick:j,children:[g!==""&&c.jsx("img",{className:"icon reset",src:H9,alt:"Refresh icon",onClick:$}),u?c.jsx("label",{style:{transform:`rotate(${C}deg)`,opacity:`${g!=="active"&&g!==""?.5:1}`},children:s>12.5||g==="active"?c.jsxs("div",{className:"active",style:{transform:`rotate(-${C}deg)`},children:[c.jsxs("span",{children:[n.length," project",n.length>1&&"s"]}),c.jsxs("span",{children:["(",Kr(s),"%)"]})]}):c.jsx("div",{className:"ball",style:{transform:`rotate(-${C}deg)`},children:c.jsx("img",{className:"icon active",src:ol,alt:"Info icon"})})}):"",f?c.jsx("label",{style:{transform:`rotate(${T}deg)`,opacity:`${g!=="finished"&&g!==""?.5:1}`},children:a>12.5||g==="finished"?c.jsxs("div",{className:"finished",style:{transform:`rotate(-${T}deg)`},children:[c.jsxs("span",{children:[i.length," project",i.length>1&&"s"]}),c.jsxs("span",{children:["(",Kr(a),"%)"]})]}):c.jsx("div",{className:"ball",style:{transform:`rotate(-${T}deg)`},children:c.jsx("img",{className:"icon finished",src:ol,alt:"Info icon"})})}):"",v?c.jsx("label",{style:{transform:`rotate(${D}deg)`,opacity:`${g!=="discarded"&&g!==""?.5:1}`},children:l>12.5||g==="discarded"?c.jsxs("div",{className:"discarded",style:{transform:`rotate(-${D}deg)`},children:[c.jsxs("span",{children:[r.length," project",r.length>1&&"s"]}),c.jsxs("span",{children:["(",Kr(l),"%)"]})]}):c.jsx("div",{className:"ball",style:{transform:`rotate(-${D}deg)`},children:c.jsx("img",{className:"icon discarded",src:ol,alt:"Info icon"})})}):""]})}P1.propTypes={data:E.array,onSelect:E.func};const B9=V.div`
  display: flex;
  flex-direction: column;
  gap: 0.8rem;
  flex-grow: 1;
...
`;function D1({className:e}){const t=U(f=>f.projects),[n,r]=P.useState(""),i=f=>{r(f)},o=f=>{Ht(f,m.white+k[3],"transparent")},s=f=>{Vt(f,"transparent")},l=t.filter(f=>f.status==="active"),a=t.filter(f=>f.status==="finished"),u=t.filter(f=>f.status==="discarded");let d=[...l,...a,...u];return n==="active"?d=l:n==="finished"?d=a:n==="discarded"&&(d=u),c.jsxs(U9,{className:`${e} box`,onMouseMove:o,onMouseLeave:s,children:[c.jsxs("div",{className:"charts",children:[c.jsx(P1,{data:t,onSelect:i}),c.jsx("hr",{}),c.jsx("span",{className:"vr"}),c.jsx(_1,{projects:d,all:n===""})]}),c.jsx(ws,{category:n,children:d.map((f,y)=>c.jsx(j0,{item:f,style:{transition:`opacity .25s ${.2*y}s, transform .5s ${.2*y}s`}},f.id))})]})}D1.propTypes={className:E.string};const W9=V.div`
  display: flex;
  flex-direction: column;
  gap: 1.2rem;
...
`;function L1({task:e,log:t,timeFrame:n,targetId:r,handleInfo:i,overlap:o,overlapNum:s}){const l=fe(),u=U(p=>p.projects).find(p=>p.id===e.projectId);let d=(t.start-n.start)/(n.end-n.start)*100,f=(t.end-t.start)/(n.end-n.start)*100,y=!1;t.start<n.start&&(d=0,f=(t.end-n.start)/(n.end-n.start)*100,y=!0);let v=!1;t.end>n.end&&(f=100-d,v=!0);const w=()=>{i({taskId:e.id,taskName:e.name,logTime:t.time})},x=()=>{i(p=>({...p,taskId:null}))},N=()=>{l(A.setTempData(e)),l(M.setFormType("task-details")),u.status==="active"?l(M.changePage("projects")):l(M.changePage("archive"))};return c.jsx(Z9,{$start:d,$width:f,$overlap:o,$overlapNum:s,className:`bar ${e.status} ${e.id===r?"targeted":""} ${y?"start":""} ${v?"end":""}`,onMouseEnter:w,onMouseLeave:x,onClick:N,children:c.jsx("p",{children:e.name})})}L1.propTypes={task:E.object,log:E.object,timeFrame:E.object,targetId:E.string,handleInfo:E.func,overlap:E.oneOfType([E.number,E.oneOf([null])]),overlapNum:E.number};const Q9=V.div`
  position: relative;
  display: inline-block;
  height: 100%;
  font-size: 1.6rem;
`;function I1({date:e,timeScale:t,targetId:n,handleInfo:r}){const i=U(d=>d.projects),o=Sn(e,"day"),s=o.start+t.start*36e5,l=o.start+t.end*36e5,a=i.reduce((d,f)=>(f.tasks.forEach(y=>{y.trackLogs.forEach(v=>{(v.start>s&&v.start<l||v.end>s&&v.end<l)&&d.push({task:y,log:v})})}),d),[]),u=Bh(a);return c.jsx(Q9,{children:u.flatMap(d=>d.map((f,y)=>c.jsx(L1,{task:f.task,log:f.log,timeFrame:{start:s,end:l},targetId:n,handleInfo:r,overlap:f.overlaps?y:null,overlapNum:f.groupSize},f.task.id+f.log.start)))})}I1.propTypes={date:E.string,timeScale:E.object,targetId:E.string,handleInfo:E.func};const Y9=V.div.attrs(({$marker:e})=>({style:{"--marker-position":`${e}%`,"--marker-display":e?"block":"none"}}))`
  display: flex;
  height: 100%;
  width: 100%;
  overflow: hidden;
...
`;function z1({className:e}){const t=fe(),n=U(j=>j.ui.timeline),[r,i]=P.useState(Sn(G(),"week")),[o,s]=P.useState({taskId:null,taskName:"",logTime:null}),l=P.useRef(null),[a,u]=P.useState(null),d=()=>{t(M.setFormType("timeline-settings"))},f=(j,$,C)=>{const T=[];if(C==="24h")for(let D=0;D<=$-j;D++)j+D<10?T.push("0"+(j+D)+":00"):T.push(j+D+":00");else if(C==="12h")for(let D=0;D<=$-j;D++)j+D===0||j+D===24?T.push("12 AM"):j+D===12?T.push("12 PM"):j+D<12?T.push(j+D+" AM"):T.push(j+D-12+" PM");return T},y=j=>{if(j==="days-full")return["Monday","Tuesday","Wednesday","Thursday","Friday","Saturday","Sunday"];if(j==="days-short")return["Mon","Tue","Wed","Thu","Fri","Sat","Sun"];if(j==="dates-full")return h.map($=>B($,"dd.mm.yyyy."));if(j==="dates-short")return h.map($=>B($,"dd.mm.yyyy.").slice(0,-5))},v=j=>{const $=l.current;if(j.target.classList.contains("bar")){const{clientX:C,clientY:T}=j,D=j.currentTarget.getBoundingClientRect(),_=C-D.left,O=T-D.top;$.style.display="flex",$.style.top=O-$.offsetHeight+"px",$.style.left=_+"px"}else $.style.display="none"},w=()=>{i(j=>Sn(j.start-36e5,"week"))},x=()=>{i(j=>Sn(j.end+36e5,"week"))},N=j=>{Ht(j,m.white+k[3],"transparent")},p=j=>{Vt(j,"transparent")},h=[];for(let j=0;j<7;j++)h.push(B(r.start+864e5*j,"yyyy-mm-dd"));const g=f(n.startAt,n.endAt,n.clockType),S=y(n.rowLabel);return P.useEffect(()=>{let j;const $=()=>{const C=G(),T=Sn(C,"day"),D=T.start+n.startAt*36e5,_=T.start+n.endAt*36e5,O=Kr((C-D)/(_-D)*100,2);u(O)};return G()>r.start&&G()<r.end?($(),j=setInterval(()=>{$()},6e4)):u(null),()=>{clearInterval(j)}},[n.startAt,n.endAt,r.start,r.end]),c.jsxs(Y9,{className:`${e} box`,$marker:a,onMouseMove:N,onMouseLeave:p,children:[c.jsxs("div",{className:"column-left",children:[c.jsxs("div",{className:"options",children:[c.jsx("img",{src:"/easytrack/chevron-bold.svg",alt:"Arrow left icon",className:"prev",onClick:w}),c.jsx("img",{src:G9,alt:"Settings icon",onClick:d}),c.jsx("img",{src:"/easytrack/chevron-bold.svg",alt:"Arrow right icon",className:"next",onClick:x})]}),c.jsx("div",{className:"vertical",children:S.map((j,$)=>c.jsx("span",{className:"segment",style:{transition:`all .1s ${.05*$}s ease-out`},children:j},j))})]}),c.jsxs("div",{className:"column-right",children:[c.jsx("div",{className:"horizontal",children:g.map((j,$)=>c.jsx("span",{className:"marker",style:{transition:`all .1s ${.05*$}s ease-out`},children:j},j+$))}),c.jsxs("div",{className:"content",onMouseMove:v,children:[c.jsxs("div",{className:"tooltip box",ref:l,children:[c.jsx("p",{children:o.taskName}),c.jsx(Je,{value:o.logTime})]}),c.jsx("div",{className:"lines",children:g.map((j,$)=>c.jsx("div",{className:"line"},$))}),h.map(j=>c.jsx(I1,{date:j,timeScale:{start:n.startAt,end:n.endAt},targetId:o.taskId,handleInfo:s},j))]})]})]})}z1.propTypes={className:E.string};const K9=V.section`
...
`;function $0({archived:e=!1,task:t,index:n}){const r=fe(),i=U(x=>x.data.trackers),[o,s]=P.useState(!0),l=x=>{x.stopPropagation(),r(M.setFormType("task-details")),r(A.setTempData(t))},a=x=>{x.stopPropagation(),r(M.setFormType("confirmation")),r(M.setConfirmationType("finish-task")),r(A.setTempData(t))},u=x=>{x.stopPropagation(),r(M.setFormType("confirmation")),r(M.setConfirmationType("discard-task")),r(A.setTempData(t))},d=x=>{x.stopPropagation(),r(y1(t))},f=x=>{x.stopPropagation(),r(M.setFormType("confirmation")),r(M.setConfirmationType("restore-task")),r(A.setTempData(t))},y=x=>{x.stopPropagation(),r(M.setFormType("confirmation")),r(M.setConfirmationType("remove-task")),r(A.setTempData(t))},v=x=>{x.stopPropagation(),r(M.changePage("trackers"))};P.useEffect(()=>{const x=setTimeout(()=>{s(!1)},n*250+1e3);return()=>clearTimeout(x)},[n]);const w=i.some(x=>x.taskId===t.id);return c.jsxs(q9,{$initial:o,$delay:n*250+250,$isTracked:w,$status:t.status,onClick:l,children:[c.jsx("h2",{children:t.name}),c.jsxs("div",{className:"tags",children:[c.jsx(Je,{value:t.time,title:"Task track time"}),!e&&c.jsx("span",{className:`priority-tag ${t.priority}`,title:"Task priority",children:t.priority})]}),c.jsx("p",{children:t.description}),c.jsxs("div",{className:"options",children:[t.status==="active"&&!e&&(w?c.jsx("img",{className:"icon",src:"/easytrack/stopwatch.svg",title:"Go to trackers",alt:"Stopwatch icon",onClick:v}):c.jsxs(c.Fragment,{children:[c.jsx("img",{className:"icon",src:O1,title:"Start tracking",alt:"Play icon",onClick:d}),c.jsx("img",{className:"icon",src:x0,title:"Finish task",alt:"Check icon",onClick:a}),c.jsx("img",{className:"icon",src:C0,title:"Discard task",alt:"Discard icon",onClick:u})]})),t.status==="discarded"&&!e&&c.jsx("img",{className:"icon",src:k0,title:"Restore task",alt:"Undo icon",onClick:f}),(t.status==="discarded"||t.status==="finished")&&c.jsx("img",{className:"icon",src:S0,title:"Delete task",alt:"Trash icon",onClick:y})]})]})}$0.propTypes={archived:E.bool,task:E.object,index:E.number};const e3=V.li`
  display: flex;
  flex-direction: column;
  gap: 1.2rem;
  padding: 2.4rem;
...
`;function R1({project:e,isExpanded:t,onClick:n}){const r=fe(),i=U(O=>O.data.trackers.some(pe=>pe.projectId===e.id)),[o,s]=P.useState("active"),l=O=>{O.stopPropagation(),r(M.setFormType("edit-project")),r(A.setTempData(e))},a=O=>{O.stopPropagation(),r(M.setFormType("confirmation")),r(M.setConfirmationType("finish-project")),r(A.setTempData(e))},u=O=>{O.stopPropagation(),r(M.setFormType("confirmation")),r(M.setConfirmationType("discard-project")),r(A.setTempData(e))},d=O=>{O.stopPropagation(),r(M.setFormType("new-task")),r(A.setTempData(e.id))},f=O=>{O.stopPropagation(),O.target.className!==o&&!O.target.classList.contains("target")&&s(O.target.className)},y=O=>{Ht(O,m.white+k[3],"transparent")},v=O=>{Vt(O,"transparent")};let w;e.tasks&&(w=e.tasks.reduce((O,pe)=>O+pe.time,0));let x=e.tasks;const N=x.filter(O=>O.status==="active"),p=x.filter(O=>O.status==="finished"),h=x.filter(O=>O.status==="discarded"),g=(N.length/x.length*100).toFixed(0)+"%",S=(p.length/x.length*100).toFixed(0)+"%",j=(h.length/x.length*100).toFixed(0)+"%",$=`(${N.length} task${N.length>1?"s":""}, ${g})`,C=`(${p.length} task${p.length>1?"s":""}, ${S})`,T=`(${h.length} task${h.length>1?"s":""}, ${j})`;o==="active"?x=N:o==="finished"?x=p:o==="discarded"&&(x=h),x.length===0&&(N.length>0?(x=N,s("active")):p.length>0?(x=p,s("finished")):h.length>0?(x=h,s("discarded")):t&&o!=="active"&&s("active"));const D=$d(x);let _="";return e.deadline-G()<2592e5&&(_="yellow"),e.deadline<G()&&(_="red"),c.jsxs(e3,{className:"box",$isExpanded:t,$taskTracked:i,onClick:n,onMouseMove:y,onMouseLeave:v,children:[c.jsxs("div",{className:"card-header",children:[c.jsx("h2",{children:e.name}),c.jsxs("div",{className:"card-header-icons",children:[c.jsx("img",{className:"icon",src:v1,title:"Edit project",alt:"Pencil icon",onClick:l}),c.jsx("img",{className:"icon",src:J9,title:"Add task",alt:"Add file icon",onClick:d}),!i&&c.jsxs(c.Fragment,{children:[c.jsx("img",{className:"icon",src:x0,title:"Finish project",alt:"Check icon",onClick:a}),c.jsx("img",{className:"icon",src:C0,title:"Discard project",alt:"Discard icon",onClick:u})]})]})]}),c.jsx("hr",{}),c.jsxs("div",{className:"card-body",children:[c.jsxs("div",{className:"info",children:[c.jsxs("div",{className:"dates",children:[c.jsxs("span",{children:[c.jsx("label",{children:"Created:"}),B(e.dateCreated,"dd.mm.yyyy."),c.jsx("br",{}),"( ",B(e.dateCreated,"hh:mm:ss")," )"]}),e.dateModified&&c.jsxs("span",{children:[c.jsx("label",{children:"Modified:"}),B(e.dateModified,"dd.mm.yyyy."),c.jsx("br",{}),"( ",B(e.dateModified,"hh:mm:ss")," )"]}),e.deadline&&c.jsxs("span",{className:_,children:[c.jsx("label",{children:"Deadline: "}),B(e.deadline,"dd.mm.yyyy."),c.jsx("br",{}),"( ",B(e.deadline,"hh:mm:ss")," )"]})]}),c.jsxs("div",{className:"tags",children:[c.jsx(Je,{value:w,title:"Project track time"}),c.jsx("span",{className:`priority-tag ${e.priority}`,title:"Project priority",children:e.priority})]})]}),c.jsx("p",{className:"project-description",children:e.description}),t&&e.tasks.length!==0&&c.jsxs("ul",{className:`project-tasks ${t?"show":""}`,children:[c.jsxs("div",{className:"chart-nav",onClick:f,children:[N.length!==0&&c.jsxs("button",{className:`active${o==="active"?" target":""}`,style:{width:g},title:`Active ${$}`,children:["Active ",$]}),p.length!==0&&c.jsxs("button",{className:`finished${o==="finished"?" target":""}`,style:{width:S},title:`Finished ${C}`,children:["Finished ",C]}),h.length!==0&&c.jsxs("button",{className:`discarded${o==="discarded"?" target":""}`,style:{width:j},title:`Discarded ${T}`,children:["Discarded ",T]})]}),x.length>0&&D.map((O,pe)=>c.jsx($0,{task:O,index:pe},O.id))]}),t&&e.tasks.length===0&&c.jsx("p",{className:"warning",children:"There are no tasks in this project yet, please create a task."})]})]})}R1.propTypes={project:E.object,isExpanded:E.bool,onClick:E.func};const t3=V.section`
  display: flex;
  flex-direction: column;
  align-items: flex-end;
  width: 100%;
...
`;function F1({tracker:e}){const t=fe(),r=U(x=>x.projects.find(N=>N.id===e.projectId)).tasks.find(x=>x.id===e.taskId),[i,o]=P.useState(()=>{if(e.status==="active")return Math.floor((G()-e.refTime+e.trackedTime)/1e3)*1e3;if(e.status==="paused")return e.trackedTime}),[s,l]=P.useState(()=>{if(e.status==="active")return!0;if(e.status==="paused")return!1}),[a,u]=P.useState(""),d=()=>{l(!0),t(o9(e))},f=()=>{l(!1),t(i9(e,i))},y=()=>{l(!1),u("fade-out"),setTimeout(()=>{const x={projectId:e.projectId,taskId:e.taskId,trackedTime:Math.floor(i/1e3)*1e3,startedAt:e.startedAt,endedAt:G()};t(Ad(x)),t(A.removeTracker(e.taskId))},2e3)},v=x=>{Ht(x,m.white+k[3],"transparent")},w=x=>{Vt(x,"transparent")};return P.useEffect(()=>{let x;return s&&(x=setInterval(()=>{o(N=>N+1e3)},1e3)),()=>{clearInterval(x)}},[s]),c.jsxs(o3,{className:"box",onMouseMove:v,onMouseLeave:w,children:[c.jsx("div",{className:"card-header",children:c.jsx("h2",{children:r.name})}),c.jsx("hr",{}),c.jsxs("div",{className:"card-body",children:[c.jsxs("div",{className:"info",children:[c.jsx(Je,{value:e.time,addition:a?i:null,title:"Task track time"}),c.jsx(Je,{value:i,className:`${s?"active":"paused"} ${a}`,title:"Current track time"})]}),c.jsx("p",{className:"task-description",children:r.description})]}),c.jsx("hr",{}),c.jsxs("div",{className:`button-group ${a&&"blocked"}`,children:[s?c.jsx("img",{src:r3,alt:"Pause icon",onClick:f,title:"Pause tracking"}):c.jsx("img",{src:O1,alt:"Play icon",onClick:d,title:"Continue tracking"}),c.jsx("img",{src:i3,alt:"Stop icon",onClick:y,title:"Stop tracking"})]})]})}F1.propTypes={tracker:E.object};const s3=V.section`
  display: flex;
  flex-direction: column;
  justify-content: center;
  gap: 1.6rem;
  width: 100%;
`;function l3(){const e=fe(),t=U(n=>n.data.trackers);return P.useEffect(()=>{t.length===0&&e(M.changePage("projects"))},[t,e]),c.jsx(s3,{children:t.map(n=>c.jsx(F1,{tracker:n},n.taskId))})}const a3=V.li`
  display: flex;
  flex-direction: column;
  gap: 1.2rem;
  padding: 1.6rem;
...
`;function A1({project:e,isExpanded:t,onClick:n}){const r=fe(),[i,o]=P.useState("finished"),s=p=>{p.stopPropagation(),r(M.setFormType("confirmation")),r(M.setConfirmationType("restore-project")),r(A.setTempData(e))},l=p=>{p.stopPropagation(),r(M.setFormType("confirmation")),r(M.setConfirmationType("remove-project")),r(A.setTempData(e))},a=p=>{p.stopPropagation(),p.target.className!==i&&!p.target.classList.contains("target")&&o(p.target.className)};let u;e.tasks&&(u=e.tasks.reduce((p,h)=>p+h.time,0));let d=e.tasks;const f=d.filter(p=>p.status==="finished"),y=d.filter(p=>p.status==="discarded"),v=(f.length/d.length*100).toFixed(0)+"%",w=(y.length/d.length*100).toFixed(0)+"%",x=`(${f.length} task${f.length>1?"s":""}, ${v})`,N=`(${y.length} task${y.length>1?"s":""}, ${w})`;return i==="finished"?d=f:i==="discarded"&&(d=y),d.length===0&&(f.length>0?(d=f,o("finished")):y.length>0?(d=y,o("discarded")):t&&i!=="finished"&&o("finished")),c.jsxs(a3,{$status:e.status,$isExpanded:t,onClick:n,children:[c.jsxs("div",{className:"card-header",children:[c.jsx("h2",{children:e.name}),c.jsxs("div",{className:"card-header-icons",children:[e.status==="discarded"&&c.jsx("img",{className:"icon",src:k0,title:"Restore project",alt:"Restore icon",onClick:s}),c.jsx("img",{className:"icon",src:S0,title:"Delete project",alt:"Trash icon",onClick:l})]})]}),c.jsx("hr",{}),c.jsxs("div",{className:"card-body",children:[c.jsxs("div",{className:"info",children:[c.jsxs("div",{className:"dates",children:[c.jsxs("span",{children:[c.jsx("label",{children:"Created:"}),B(e.dateCreated,"dd.mm.yyyy."),c.jsx("br",{}),"( ",B(e.dateCreated,"hh:mm:ss")," )"]}),e.dateFinished&&c.jsxs("span",{children:[c.jsx("label",{children:"Finished:"}),B(e.dateFinished,"dd.mm.yyyy."),c.jsx("br",{}),"( ",B(e.dateFinished,"hh:mm:ss")," )"]}),e.dateDiscarded&&c.jsxs("span",{children:[c.jsx("label",{children:"Discarded:"}),B(e.dateDiscarded,"dd.mm.yyyy."),c.jsx("br",{}),"( ",B(e.dateDiscarded,"hh:mm:ss")," )"]}),e.deadline&&c.jsxs("span",{children:[c.jsx("label",{children:"Deadline: "}),B(e.deadline,"dd.mm.yyyy."),c.jsx("br",{}),"( ",B(e.deadline,"hh:mm:ss")," )"]})]}),c.jsx(Je,{value:u,title:"Project track time"})]}),c.jsx("p",{className:"project-description",children:e.description}),t&&e.tasks.length!==0&&c.jsxs("ul",{className:`project-tasks ${t?"show":""}`,children:[c.jsxs("div",{className:"chart-nav",onClick:a,children:[f.length!==0&&c.jsxs("button",{className:`finished${i==="finished"?" target":""}`,style:{width:v},title:`Finished ${x}`,children:["Finished ",x]}),y.length!==0&&c.jsxs("button",{className:`discarded${i==="discarded"?" target":""}`,style:{width:w},title:`Discarded ${N}`,children:["Discarded ",N]})]}),d.length>0&&d.map((p,h)=>c.jsx($0,{task:p,index:h,archived:!0},p.id))]}),t&&e.tasks.length===0&&c.jsx("p",{className:"warning",children:"There are no tasks in this project."})]})]})}A1.propTypes={project:E.object,isExpanded:E.bool,onClick:E.func};const c3=V.section`
  width: 100%;
...
`;function H1({page:e,isMini:t}){let n;return e==="welcome"?n=c.jsx(R9,{}):e==="dashboard"?n=c.jsx(X9,{}):e==="projects"?n=c.jsx(n3,{}):e==="trackers"?n=c.jsx(l3,{}):e==="archive"&&(n=c.jsx(u3,{})),c.jsx(d3,{$page:e,$isMini:t,children:n})}H1.propTypes={page:E.node,isMini:E.bool};function f3(){const e=fe(),t=U(s=>s.ui.page),n=U(s=>s.ui.minimizedHeader),r=U(s=>s.projects),i=U(s=>s.data.trackers),o=P.useRef(!0);return P.useEffect(()=>{if(o.current){e(Qm()),e(Dm()),o.current=!1;return}else e(Mm(r))},[r,e]),P.useEffect(()=>{const s=()=>{i.forEach(l=>{let a;l.status==="active"?a=Math.floor((G()-l.refTime+l.trackedTime)/1e3)*1e3:l.status==="paused"&&(a=l.trackedTime);const u={projectId:l.projectId,taskId:l.taskId,trackedTime:Math.floor(a/1e3)*1e3,startedAt:l.startedAt,endedAt:G()};e(Ad(u))})};return window.addEventListener("pagehide",s),()=>{window.removeEventListener("pagehide",s)}},[i,e]),c.jsxs(c.Fragment,{children:[c.jsx(K5,{page:t,isMini:n}),c.jsx(r9,{}),c.jsx(j9,{}),c.jsx(L9,{}),c.jsx(H1,{page:t,isMini:n})]})}const p3=mm({reducer:{ui:_m,data:Em,projects:Nm}});xd(document.getElementById("root")).render(c.jsx(P.StrictMode,{children:c.jsx(Mh,{store:p3,children:c.jsx(f3,{})})}));
